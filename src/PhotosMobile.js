    ...
    return (
        <motion.div className='PhotosMobile'>
            ...
            <motion.div class="parent2">
                ...
                <motion.div onClick={() => { window.location.href = "https://adobe.ly/3YDJmsW"; }} class="div32"><motion.p className='ImageTitles1'>Travel</motion.p> <motion.img className='Mountains' src={ZürichMobile}></motion.img> </motion.div>
                <motion.div onClick={() => { window.location.href = "https://adobe.ly/45t5kBL"; }} class="div42"><motion.p className='ImageTitles1'>Wildlife</motion.p> <motion.img className='Mountains' src={WildlifeMobile}></motion.img>  </motion.div>
            </motion.div>
        </motion.div>
    );
}
