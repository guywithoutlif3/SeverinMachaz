...
function App() {
  ...
  const duration = useTransform(scrollY, [0, 3000], [15, 1]);
  ...
  return (
    <div className="App" data-darkmode={mode}>
      ...
      <div className="idfk">
            ...
            <motion.div>
              ...
              <motion.div>
                ...
                <motion.p
                  ...
                  className="WorkSub"
                >
                  Welcome to my Work page! Here, you'll find a concise display
                  of my skills and the tools I proficiently utilize.
                </motion.p>
        ...
        {screenWidth < 500 ? (
          <MotionConfig>
            <motion.div className="MobileStartContainer">
              <motion.div
                animate={{ y: [1000, 0] }}
                transition={{ duration: 1 }}
              >
